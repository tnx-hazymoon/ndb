...
<tr>
	<th colspan=3>ＡＢＯＵＴ　ＣＡＳＴ</th>
	<th><a href="<?php echo $_SERVER['SCRIPT_NAME']; ?>?CMD=view&CID=<?php echo sprintf( "%d",$CONT_CID ); ?>">キャスト詳細画面に戻る</a></th>
</tr>
<tr>
	<th>HANDLE</th>
...
<tr>
	...
	<tr>
		<th colspan=5>
			...
			<input type=submit value=編集完了／更新><br>
		</th>
	</tr>
</table>
</form>
